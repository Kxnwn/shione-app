...
const buildProfileContext = async (userId: number) => {
...
const buildMoodContext = async (userId: number) => {
...
const buildJournalContext = async (userId: number) => {
...
const buildMemoryContext = async (userId: number) => {
...
const buildConversationContext = async (userId: number) => {
